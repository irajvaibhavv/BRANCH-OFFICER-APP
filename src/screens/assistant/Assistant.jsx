...
import { FiMic, FiMicOff, FiVolume2, FiVolumeX, FiSend, FiUser, FiUsers, FiChevronRight, FiChevronLeft, FiCheck, FiAlertTriangle, FiInfo, FiAlertCircle, FiSearch, FiRefreshCw, FiShield, FiMapPin, FiType, FiList } from 'react-icons/fi';
...
import { FLOWS, reflect, buildReport } from '../../services/assistant/flows';
import { speak as tts, stopSpeaking, prefetch, listen, canSpeak, canListen } from '../../services/voice';
import styles from './assistant.module.css';

// SAARTHI AI handover interviews: AIHome (/ai) · AISession (/ai/session) · AIReport (/ai/reports/:id)
