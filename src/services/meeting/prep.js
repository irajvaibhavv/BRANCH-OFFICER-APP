// Rule-based meeting questions for a DSA, from approval rate, product mix, pending files, visit gap and commitments.
import { productMix, commissionFor } from '../../utils/commission';
