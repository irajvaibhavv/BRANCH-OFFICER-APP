/*
  Simulated "meeting intelligence" for the POC.
  In production the audio goes to a speech-to-text service and an LLM produces the
  summary; here we generate a realistic, DSA-specific transcript + summary locally so
  the flow can be demoed offline with zero latency.
*/
import { toISODate, formatDate } from './formatters';
