/*
  ...
  Flow node: { id, say(ctx) → string[] (one or more bubbles), options?: string[], input?: 'text'|'money'|'number',
               next(answer, ctx) → node id | null,  key?: field to store the answer under }
*/
import { PRODUCT_RATES, emi, maxLoan, FOIR } from './loanCalc';
